...
{
    public class wAnimationManager : MonoBehaviour, IAnimationManager
    {
        //**************************************************\\
        //********************* Fields *********************\\
        //**************************************************\\
        ...
        public IAnimationState CurrentAnimationState 
        {
            ...
            private set
            {
                if (_currentAnimationState != value)
                {
                    ...
                    _currentAnimationState.OnStateEnter();
                    _animator.Play(_currentAnimationState.Animation.name/*, _combatant.CurrentWeapon.AnimationLayer*/);
